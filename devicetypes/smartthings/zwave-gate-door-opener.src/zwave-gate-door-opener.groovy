 ...
 */
metadata {
	definition (name: "Z-Wave Gate Door Opener", namespace: "smartthings", author: "SmartThings", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, ocfDeviceType: "oic.d.garagedoor") {
		capability "Actuator"
